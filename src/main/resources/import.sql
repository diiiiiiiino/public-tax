...
insert into member (id, login_id, password, name, mobile, state) values (2, 'admin', '$2a$10$ZnjZRn513vzMHzMG2DK6Du7Jq6lvC3mejgYOnssvMCPa1b8LEGmVG', '관리자', '01012345679', 'ACTIVATION');
insert into member_authority(id, member_id, authority_id) values (1, 1, 2);
insert into member_authority(id, member_id, authority_id) values (2, 2, 1);