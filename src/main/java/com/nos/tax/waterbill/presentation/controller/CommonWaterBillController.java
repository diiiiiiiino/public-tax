...
public class CommonWaterBillController {
    ...
    @GetMapping
    Response<ThisMonthWaterBillInfo> getThisMonthWaterMeters(@RequestParam Long buildingId, @RequestParam YearMonth calculateYm){
        return Response.ok(waterBillQueryService.getThisMonthWaterBillInfo(buildingId, calculateYm));
    }
}
